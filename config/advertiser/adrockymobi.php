...
return [
    ...
    'offer_api'           => 'http://rockymobipanshi.fuseclick.com/api/v1/getOffers?key=3FDEE8FB6B243DD2F3B2B62843760563&a=147&page=1&limit=1000',
    //'set_cookie'     =>    '',
    //'offer_api_post_json' => '',
    'creative_api'        => '',
    'advertiser_id'  => '357',
    ...
    'offer_filter'        => [    //数据过滤，return false 则跳过当前offer 可自定义过滤条件，如下所示
        ...
        'offer_id'    => function ($var) {
            $arr = [7635,7587,2551,6021,7858,7852,7825,7734,7669,7647];
    ...
    'conversion_field'    => [
        ...
        'offer_category'  => function ($var) {
            $tag = 'CPA';
            if (strpos($var['description'], 'flow: 2Click') != false) {
