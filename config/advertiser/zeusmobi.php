...
return [
    ...
    'offer_api'           => 'http://exchange.zeusmobi.com/get?dev=6636&key=92f32530f48a493fa68ff24362267d2b&page=1&size=1000',
    //'set_cookie'     =>    '',
    //'offer_api_post_json' => '',
   // 'set_header' => '',
    'creative_api'        => '',
    ...
    'conversion_field'    => [
        'offer'          => [
            ...
            'destination_url' => function ($var) { //具体参数对接见广告主侧文档
                ...
                return $var[ 'shortLink' ] = str_replace(array_keys($fill_vars), array_values($fill_vars), $var[ 'shortLink' ]);
        ...
        'offer_platform' => [
            'target' => function ($var) {    //匹配offer platform
                $platform = [];
                if (strpos($var['previewLink'], 'itunes') != false) {
                    $platform[] = [
                        'platform' => "Mobile",
                        'system'   => 'iOS',
                        'version'  => [],
                ...
                if (strpos($var['previewLink'], 'google') != false) {
                    $platform[] = [
                        'platform' => "Mobile",
                        'system'   => 'Android',
                        'version'  => [],
        ...
        'offer_geo'      => [
            'target' => function ($var) { //匹配offer geo
                ...
                $geo = explode(',', $var[ 'geos' ]);  //get 广告主国家
                $target = [];
