...
return [
    ...
    'http_basic_auth'  => ['karen@leanmobi.com', '912e81c460b9418692b60ee47f714320'],
    'offer_api'           => 'https://chance.api.offerslook.com/aff/v1/batches/offers?filters[status]=active&type=personal&contains=description&offset=1&limits=500',
    //'set_cookie'     =>    '',
    //'offer_api_post_json' => '',
    'creative_api'        => '',
    'advertiser_id'  => '235',
    ...
    'offer_filter'        => [    //数据过滤，return false 则跳过当前offer 可自定义过滤条件，如下所示
        'revenue' => function ($var) {
            return (float)$var['offer'][ 'payout' ] < 0 ? false : true;
        },
    ],
    'conversion_field'    => [
        'offer'          => [
        ...
        'offer_platform' => [
            'target' => function ($var) {    //匹配offer platform
                ...
                return $var['offer_platform']['target'];
                $platform = [];
                if ($var[ 'os' ] == 'ios') {
                    $platform[] = [
                        'platform' => "Mobile",
