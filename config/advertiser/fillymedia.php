...
return [
    ...
    'offer_api'           => 'http://api.fillymedia.affise.com/3.0/offers?limit=1000',
    //'offer_api_post_json' => '',
    'set_header'   =>  ["Api-Key: 2b4888c19b0f22f08ad36e7f9451c41bc4b04dc8"],
    'creative_api'        => '',
    'geo_api'             => '',
    ...
    'offer_filter'        => [
        ...
        'cpi'  => function ($var) {
            return $var['is_cpi'] = 'true' ? true : false;

        },
        'link' => function ($var) {
            return empty($var['link']) ? false : true;
        },
    ...
    'conversion_field'    => [
        'offer'          => [
            ...
            'destination_url' => function ($var) {
                ...
                //
                return $var[ 'link' ] . "&sub2={click_id}&sub1={aff_id}_{source_id}";
            },
