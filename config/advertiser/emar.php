...
return [
    ...
    'offer_api'           => 'http://cpisvr.emarbox.com/offer?token=030251078af8789256a7df6ea06ddc16&size=100',
    //'offer_api_post_json' => '',
    'advertiser_id'       => 326,
    'creative_api'        => '',
    'geo_api'             => '',
    'offer_list'          => function ($data) {
        return isset($data[ 'data' ][ 'offers' ]) ? $data[ 'data' ][ 'offers' ] : null;
    },
    'pay_out_rate'        => 0.8,
    'offer_filter'        => [
    ...
    'conversion_field'    => [
        'offer'          => [
            ...
            'name'            => function ($var) {
                //AE|SA
                $name = fmtOfferName($var[ 'name' ] . " " . $var[ 'os' ] . " [" . $var[ 'geo' ] . "]");
            ...
            'destination_url' => function ($var) {
                ...
                */
                return $var[ 'clickUrl' ] . "&extraInfo1={click_id}&sub={aff_id}_{source_id}&gaid={google_aid}&idfa={ios_idfa}";
            },
            'description'     => 'kpi',
            'currency'        => function () {
                return 'USD';
