...
return [
    ...
    'offer_params'     => ['payout'],
    'offer_api'        => 'http://ofwall.com/api/v1?show_creative=true&api_key=5X6nuwvX5X3ePx7wILO4WU4SjGUQ1GE0&pub_id=6737&c=8435&incent=3&os=Ios&country=ALL&campaign_limit=300',
    'creative_api'     => '',
    'geo_api'          => '',
    ...
    'conversion_field' => [
        'offer'          => [
            'name'            => function ($var) {
                $name = fmtOfferName($var[ 'title' ] . " iOS [" . $var[ 'countries' ] . "]");
            ...
            'preview_url'     => function ($var) {
                //https://itunes.apple.com/us/app/id1227605924
                return "https://itunes.apple.com/us/app/" . $var[ 'appid' ];
            },
