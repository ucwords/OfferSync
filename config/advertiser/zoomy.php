...
return [
    ...
    'offer_api'           => 'http://api.clinkad.com/offer_api_v3?key=hpvao0srzns31q9h&pubid=7883',
    //'set_cookie'     =>    '',
    //'offer_api_post_json' => '',
    'set_header' => '',
    'creative_api'        => '',
    ...
    'conversion_field'    => [
        'offer'          => [
            ...
            'destination_url' => function ($var) { //具体参数对接见广告主侧文档
                ...
                */
                //方式二，自己拼接
                return $var[ 'tracking_link' ] . "&sid={click_id}&subpubid={aff_id}_{source_id}&gaid={google_aid}&idfa={ios_idfa}";
            },
