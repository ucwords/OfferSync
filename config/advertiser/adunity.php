...
return [
    ...
    'offer_api'           => 'http://api.c.adunity.mobi/ads2s?sourceid=31441&pagenum=1000',
    //'offer_api_post_json' => '',
    'creative_api'        => '',
    'geo_api'             => '',
    'offer_list'          => function ($data) {
        return isset($data[ 'offers' ]['offer']) ? $data[ 'offers' ]['offer'] : null;
    },
    'pay_out_rate'        => 0.8,
    'offer_filter'        => [
    ...
    'conversion_field'    => [
        'offer'          => [
            'name'            => function ($var) {
                //AE|SA
                $name = fmtOfferName($var[ 'title' ] . " " . $var[ 'os' ] . " [" . $var[ 'geos' ] . "]");
            ...
            'preview_url'     => function ($var) {
                if ($var[ 'os' ] == 'android') {
                    return 'https://play.google.com/store/apps/details?id=' . $var[ 'package' ];
                }
                if ($var[ 'os' ] == 'ios') {
                    return 'https://itunes.apple.com/us/app/id' . $var[ 'package' ];
                }              
            },
            'destination_url' => function ($var) {
     
                return $var[ 'click_url' ] . "&dv1={click_id}&sub_aff={aff_id}";
            },
            'description'     => 'desc',
        ...
        'offer_geo'      => [
            'target' => function ($var) {
                ...
                if (is_array($geo)) {
                    ...
                    $target[] = [
                        "type"    => 2,
                        "country" => $countries[ $var[ 'geos' ] ][ 'name' ],
                        "city"    => [],
                    ];
                }
                //dd($target);
