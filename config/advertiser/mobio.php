...
return [
    ...
    'offer_api'           => 'http://api.mobio.affise.com/3.0/partner/offers',
    //'offer_api_post_json' => '',
    'set_header'   =>  ["API-key: aac7128b19b43a60b4086b7535adbe31c8808e99"],
    'advertiser_id'   => 417,
    'creative_api'        => '',
    'geo_api'             => '',
    ...
    'offer_filter'        => [
        'revenue' => function ($var) {
            return (float)$var['payments'][0][ 'revenue' ]< 0.1 ? false : true;
        },
        'offer_id'    => function ($var) {
            $arr = [1536919,818825,1183933,795771,799846,460911,1399063,1535755,408];
    ...
    'conversion_field'    => [
        'offer'          => [
            ...
            'name'            => function ($var) {
                //AE|SA
                $name = fmtOfferName($var[ 'title' ] . " " . $var['payments'][0][ 'os' ][0] . " [" . $var[ 'countries' ][0] . "]");
        ...
        'offer_platform' => [
            'target' => function ($var) {
                ...
                if ($var['payments'][0][ 'os' ][0] == 'Android') {
                    $platform[] = [
                        'platform' => "Mobile",
                        'system'   => 'Android',
                        'version'  => [],
        ...
        'offer_cap'      => [
            ...
            'adv_cap_conversion' => function ($var) { return 70; },
            //'adv_cap_revenue',
