...
return [
   ...
   // 'http_basic_auth'  => ['karen@leanmobi.com', 'nVvq5bWEPGWu2for9vGLfuRPeQkNf0eV'],
    'offer_api'           => 'http://api.online.mobcastlead.com/channel/offer?sid=222&secret=17aee3985cb063349cad4bd9e002195a&page=2&pagesize=500',
    //'set_cookie'     =>    '',
    //'offer_api_post_json' => '',
    //'set_header' => '',
    'creative_api'        => '',
    ...
    'conversion_field'    => [
        'offer'          => [
            ...
            'name'            => function ($var) {
                ...
                return isset($var[ 'app_name' ]) ? $var[ 'app_name' ] : null;
            },
    ...
    /*'conversion_creative' => function ($item) {
        //dd($item[ 'app_icon' ]);
        $creative = [];
        $icon_url = isset($item[ 'app_icon' ]) ? $item[ 'app_icon' ] : null;   //offer icon  处理JPG,png 没问题， webp格式自己想办法。
        ...
        if (isset($item[ 'material' ]) && !empty($item[ 'material' ])) {  //offer creative
